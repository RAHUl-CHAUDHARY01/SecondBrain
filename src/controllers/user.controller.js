...
var signUp = (0, asynchandler_1.asyncHandler)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var username, password, existedUser, user, createdUser;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, user_model_1.User.findOne({ $or: [{ username: username }] })];
            case 1:
                existedUser = _a.sent();
                if (existedUser) {
                ...
                return [4 /*yield*/, user_model_1.User.create({ username: username, password: password })];
            case 2:
                user = _a.sent();
